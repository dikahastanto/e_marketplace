    ...
    <div class="row">
      <div class="col-sm-3">
        <div class="left-sidebar">
          ...
          <div class="panel-group category-products" id="accordian"><!--category-productsr-->
            @foreach($kategori as $kategori_barang)
      ...
      <div class="col-sm-9 padding-right">
        <div class="features_items"><!--features_items-->
          <h2 class="title text-center">Semua Barang</h2>
              ...
              <div class="single-products">
                ...
                <div class="product-overlay">
                  <div class="overlay-content">
                    ...
                    <p>{{$tampil_barang->nama_barang}}</p>
                    <div class="row">
                      <a href="{{ route('buy',$tampil_barang->id_barang) }}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Beli</a>
                      <a href="{{ route('tapil_detail_barang',$tampil_barang->id_barang) }}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Detail</a>
                    </div>
                  </div>
                </div>
              </div>
